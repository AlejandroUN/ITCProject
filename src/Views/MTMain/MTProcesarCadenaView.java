 ...
 * @author aleja
 */
public class MTProcesarCadenaView extends javax.swing.JFrame {

    MT mt;
    /**
     * Creates new form MTProcesarCadenaView
     */
    public MTProcesarCadenaView(MT mt) {
        initComponents();
        questionLabel.hide();
        answerLabel.hide();
        this.mt = mt;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Máquina de Turing - Procesar Cadena");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        answerLabel.setText(Boolean.toString(mt.procesarCadena(string)));
        answerLabel.show();
        questionLabel.show();
