 ...
 * @author aleja
 */
public class MTProcesarCadenaConDetallesView extends javax.swing.JFrame {

    MT mt;
    /**
     * Creates new form MTProcesarCadenaConDetallesView
     */
    public MTProcesarCadenaConDetallesView(MT mt) {
        initComponents();
        this.mt = mt;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Máquina de Turing Procesar Cadena con Detalles");
    ...
    private void processButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processButtonActionPerformed
        questionLabel.show();
        answerLabel.setText(Boolean.toString(mt.procesarCadenaConDetalles(stringTf.getText())));
        answerLabel.show();
        stringProcessTf.setText(mt.procesarCadenaConDetallesString(stringTf.getText()));
