 ...
 * @author aleja
 */
public class AFDProcesarListaCadenasView extends javax.swing.JFrame {

    AFD afd;
    /**
     * Creates new form AFDProcesarListaCadenasView
     */
    public AFDProcesarListaCadenasView(AFD afd) {
        initComponents();
        proccesTa.hide();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Boolean.parseBoolean((String)jComboBox1.getSelectedItem())){
            proccesTa.setText(afd.procesarListaCadenasString(strings, fileNameTf.getText()));        
            proccesTa.show();
        }else{            
            afd.procesarListaCadenas(strings, fileNameTf.getText(), Boolean.parseBoolean((String)jComboBox1.getSelectedItem()));
        }        
