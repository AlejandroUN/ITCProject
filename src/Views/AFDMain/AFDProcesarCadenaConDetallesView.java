 ...
 * @author aleja
 */
public class AFDProcesarCadenaConDetallesView extends javax.swing.JFrame {

    AFD afd;
    /**
     * Creates new form AFDProcesarCadenaConDetallesView
     */
    public AFDProcesarCadenaConDetallesView(AFD afd) {
        initComponents();
        this.afd = afd;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AFD Procesar Cadena con Detalles");
    ...
    private void processButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processButtonActionPerformed
        questionLabel.show();
        answerLabel.setText(Boolean.toString(afd.procesarCadenaConDetalles(stringTf.getText())));
        answerLabel.show();
        stringProcessTf.setText(afd.procesarCadenaConDetallesString(stringTf.getText()));
