 ...
 * @author aleja
 */
public class MTMCProcesarCadenaView extends javax.swing.JFrame {

    MTMC mtmc;
    /**
     * Creates new form MTMCProcesarCadenaView
     */
    public MTMCProcesarCadenaView(MTMC mtmc) {
        initComponents();
        questionLabel.hide();
        answerLabel.hide();
        this.mtmc = mtmc;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MTMC Procesar Cadena");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        answerLabel.setText(Boolean.toString(mtmc.procesarCadena(string)));
        answerLabel.show();
        questionLabel.show();
