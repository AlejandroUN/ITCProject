 ...
 * @author aleja
 */
public class MTMCProcesarCadenaConDetallesView extends javax.swing.JFrame {

    MTMC mtmc;
    /**
     * Creates new form MTMCProcesarCadenaConDetallesView
     */
    public MTMCProcesarCadenaConDetallesView(MTMC mtmc) {
        initComponents();
        this.mtmc = mtmc;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MTMC Procesar Cadena con Detalles");
    ...
    private void processButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processButtonActionPerformed
        questionLabel.show();
        answerLabel.setText(Boolean.toString(mtmc.procesarCadenaConDetalles(stringTf.getText())));
        answerLabel.show();
        stringProcessTf.setText(mtmc.procesarCadenaConDetallesString(stringTf.getText()));
