 ...
 * @author aleja
 */
public class AFPDProcesarCadenaConDetalles extends javax.swing.JFrame {

    AFPD afpd;
    /**
     * Creates new form AFPDProcesarCadenaConDetalles
     */
    public AFPDProcesarCadenaConDetalles(AFPD afpd) {
        initComponents();
        this.afpd = afpd;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AFPD Procesar Cadena con Detalles");
    ...
    private void processButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processButtonActionPerformed
        questionLabel.show();
        answerLabel.setText(Boolean.toString(afpd.procesarCadenaConDetalles(stringTf.getText())));
        answerLabel.show();
        stringProcessTf.setText(afpd.procesarCadenaConDetallesString(stringTf.getText()));
